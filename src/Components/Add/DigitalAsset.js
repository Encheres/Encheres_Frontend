...
class DigitalAsset extends Component {
    ...
    async createItem() {
        if (this.formValidattion()) {
            const { name, assetFileHash, description, categoriesId, royality } =
                this.state;

            await this.state.nftasset_contract.methods
                .mintNftAsset(
                    name,
                    assetFileHash,
                    description,
                            ...
                            <CardBody>
                                ...
                                <div className="new-item-dropbox">
                                    <CardText className="new-item-card-text">
                                        PNG, JPEG, GIF, WEBP, PDF, DOCX, MP4 or
                                        MP3. Max 100mb
                                    </CardText>
                            ...
                            <CardBody>
                                ...
                                <div>
                                    ...
                                    <Badge
                                        ...
                                        text="dark"
                                        onClick={() =>
                                            this.addCategory("Domain Names", 2)
                                        }
                                        bg={
                                            this.state.categories.indexOf(
                                                "Domain Names"
                                    ...
                                    <Badge
                                        ...
                                        text="dark"
                                        onClick={() =>
                                            this.addCategory("Trading Cards", 4)
                                        }
                                        bg={
                                            this.state.categories.indexOf(
                                                "Trading Cards"
                                    ...
                                    <Badge
                                        ...
                                        text="dark"
                                        onClick={() =>
                                            this.addCategory("Collectibles", 5)
                                        }
                                        bg={
                                            this.state.categories.indexOf(
                                                "Collectibles"
