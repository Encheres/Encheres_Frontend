...
contract Auctions{
    ...
    function CreateAuction(uint _nftId, address payable _ownerAccount, uint _ownerId, uint _auctionEndTime, uint _auctionStartPrice) public payable{
    ...
    function BidAuction(uint _nftId, uint _auctionCurrentBid, uint _auctionCurrentBidder, address payable _auctionBuyer) public{
    ...
    function EndAuction(uint _nftId) public{
        ...
        require(auctionMap[_nftId].auctionEndTime <= block.timestamp, "Auction has not ended yet");
    ...
    function GetAuctionDetails(uint _nftId) public view returns(address payable, uint, uint, uint, uint, bool, bool){
        require(_nftId >= 0, "Invalid nftId");
